...
export default function AgentPlan() {
  ...
  return (
    <div className="bg-[#0c0c0c] text-[#f7eee3] h-full overflow-auto p-2">
      <motion.div 
        className="bg-[#0c0c0c] border border-[#f7eee3]/20 rounded-lg shadow overflow-hidden"
                ...
                return (
                  ...
                  >
                    ...
                    <motion.div 
                      ...
                      whileHover={{ 
                        backgroundColor: "rgba(247, 238, 227, 0.05)",
                    ...
                    >
                      ...
                      >
                        <div className="mr-2 flex-1 truncate">
                          <span
                            className={`${isCompleted ? "text-[#f7eee3]/50 line-through" : "text-[#f7eee3]"}`}
                          >
                            {task.title}
                          </span>
                        </div>
                            ...
                            <div className="flex items-center mr-2">
                              <div className="flex flex-wrap gap-1">
                                {task.dependencies.map((dep, idx) => (
                                  <motion.span
                                    key={idx}
                                    className="bg-[#f7eee3]/10 text-[#f7eee3]/80 rounded px-1.5 py-0.5 text-[10px] font-medium border border-[#f7eee3]/20"
                                    ...
                                    whileHover={{ 
                                      y: -1, 
                                      backgroundColor: "rgba(247, 238, 227, 0.15)",
                                      transition: { duration: 0.2 } 
                                    }}
                                  >
                                    {dep}
                              ...
                              return (
                                ...
                                >
                                  <motion.div 
                                    ...
                                    whileHover={{ 
                                      backgroundColor: "rgba(247, 238, 227, 0.03)",
                                      transition: { duration: 0.2 }
                                    }}
                                    layout
                                  >
                                    ...
                                    <span
                                      className={`cursor-pointer text-sm ${subtask.status === "completed" ? "text-[#f7eee3]/50 line-through" : "text-[#f7eee3]"}`}
                                    >
                                      {subtask.title}
                                    </span>
                                  </motion.div>
                                  ...
                                  <AnimatePresence mode="wait">
                                    {isSubtaskExpanded && (
                                      <motion.div 
                                        className="text-[#f7eee3]/60 border-[#f7eee3]/20 mt-1 ml-1.5 border-l border-dashed pl-5 text-xs overflow-hidden"
                                      ...
                                      >
                                        ...
                                        {subtask.tools && subtask.tools.length > 0 && (
                                          <div className="mt-0.5 mb-1 flex flex-wrap items-center gap-1.5">
                                            <span className="text-[#f7eee3]/60 font-medium">
                                              MCP Servers:
                                            </span>
                                            <div className="flex flex-wrap gap-1">
